...
#define CAN_MESSAGE_ID_TX           0x90                       /* Message ID that will be used in arbitration phase */
#define CAN_MESSAGE_ID_RX           0x91                       /* Message ID that will be used in arbitration phase */
