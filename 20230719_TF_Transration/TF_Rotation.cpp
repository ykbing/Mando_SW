...
Point2D   base_link_Point2D, base_link_map_Point2D, map_link_Point2D, base_link_2D, base_link_map_2D;
...
void TF_base_link_base_link_map(Point2D base_link_Point2D, Point2D* base_link_map_point2d, Pose2D base_link_origin)
{
 ...
 //  base_link_map => map
void TF_base_link_map_map(Point2D map_link_Point2d, Point2D* base_link_map_point2d, Pose2D base_link_origin)
{
	map_link_Point2d.x = (base_link_map_point2d->x + base_link_origin.x);
	map_link_Point2d.y = (base_link_map_point2d->y + base_link_origin.y);
	printf("\n");
...
void TF_base_link_map(Point2D base_link_2D, Point2D* base_link_map_2D, Pose2D base_link_origin)
{
	...
	TF_base_link_map_map(map_link_Point2D, base_link_map_2D, base_link_origin);
}
///////////////////////////////////////////////////////////////////////////////////////////////////////////////

/*******************************2. map -> base_link *************************************/
//  map => base_link_map
void TF_map_base_link_map(Point2D map_link_Point2d, Point2D* base_link_map_point2d, Pose2D base_link_origin)
{
	base_link_map_point2d->x = (map_link_Point2d.x - base_link_origin.x);
	base_link_map_point2d->y = (map_link_Point2d.y - base_link_origin.y);
	printf("\n");
	printf("/*******************************2. map -> base_link *************************************/\n");
	printf("(1) map -> base_link_map \n");
	printf("map_link_point2d_X: %6.3lf		map_link_point2d_Y: %6.3lf\n", map_link_Point2d.x, map_link_Point2d.y);
	printf("base_link_map_point2d_X: %6.3lf		base_link_map_point2d_Y: %6.3lf\n", base_link_map_point2d->x, base_link_map_point2d->y);
}
...
{
	TF_map_base_link_map(map_link_Point2D, base_link_map_2D, base_link_origin);
...
{
	map_link_Point2D.x = 4.0;
	map_link_Point2D.y = 4.0;

	base_link_2D.x = 1;
	base_link_2D.y = -1;

	base_link_map_2D.x = 1;
	base_link_map_2D.y = 1;

	Input_Data();

	TF_base_link_map(base_link_2D, &base_link_map_2D, base_link_origin);
	TF_map_base_link(base_link_2D, &base_link_map_2D, base_link_origin);
