...
/*------------------------------------------------------Macros-------------------------------------------------------*/
/*********************************************************************************************************************/
#define SRC_MESSAGE_OBJECT_ID1       (IfxMultican_MsgObjId)0     /* Source message object ID                          */
#define DST_MESSAGE_OBJECT_ID1       (IfxMultican_MsgObjId)1     /* Destination message object ID                     */
#define SRC_MESSAGE_OBJECT_ID2       (IfxMultican_MsgObjId)2     /* Source message object ID                          */
#define DST_MESSAGE_OBJECT_ID2       (IfxMultican_MsgObjId)3     /* Destination message object ID                     */

#define CAN_MESSAGE_ID1             0x777                       /* Message ID that will be used in arbitration phase */
#define CAN_MESSAGE_ID_TX1          0x90                       /* Message ID that will be used in arbitration phase */
#define CAN_MESSAGE_ID_RX1          0x91                       /* Message ID that will be used in arbitration phase */
#define TX_INTERRUPT_SRC_ID1        IfxMultican_SrcId_0         /* Transmit interrupt service request ID             */
#define RX_INTERRUPT_SRC_ID1        IfxMultican_SrcId_1         /* Receive interrupt service request ID              */


#define CAN_MESSAGE_ID2             0x778                       /* Message ID that will be used in arbitration phase */
#define CAN_MESSAGE_ID_TX2          0x91                       /* Message ID that will be used in arbitration phase */
#define CAN_MESSAGE_ID_RX2          0x90                       /* Message ID that will be used in arbitration phase */
#define TX_INTERRUPT_SRC_ID2        IfxMultican_SrcId_3         /* Transmit interrupt service request ID             */
#define RX_INTERRUPT_SRC_ID2        IfxMultican_SrcId_4         /* Receive interrupt service request ID              */
...
#define ISR_PRIORITY_CAN_TX1         3                           /* Define the CAN TX interrupt priority              */
#define ISR_PRIORITY_CAN_RX1         1                           /* Define the CAN RX interrupt priority              */

#define ISR_PRIORITY_CAN_TX2         4                           /* Define the CAN TX interrupt priority              */
#define ISR_PRIORITY_CAN_RX2         2                           /* Define the CAN RX interrupt priority              */
